...
import 'package:food_catering_service_app/models/breakfastModel.dart';

class BreakFastProvider extends ChangeNotifier {
  final List<Breakfast> _breakfast = [
    Breakfast(
      price: 40.45,
      about:
  ...
  List<Breakfast> get breakfast => _breakfast;
}
